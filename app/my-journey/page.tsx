        ...
        <main className="min-lg:w-3/4">
            ...
            <Accordion type="multiple">
                ...
                <AccordionItem value="companions">
                    <AccordionTrigger className="text-2xl">My Companions {`(${companions.length})`}</AccordionTrigger>
                    <AccordionContent><CompanionsList title="My Companions" companions={companions}/>
                    </AccordionContent>
                </AccordionItem>
            </Accordion>
        </main>
